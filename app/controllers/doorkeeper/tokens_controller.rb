...
module Doorkeeper
  class TokensController < Doorkeeper::ApplicationMetalController
    ...
    swagger_controller :Users, 'User Sign In'

    swagger_api :create do |api| 
      summary 'User Sign In'
      param :query, "email", :string, :required, 'Email Address'
      param :query, "password", :string, :required, 'Enter password'
      param :query, "grant_type", :string, :required, "Grant should be 'password'"
    end
